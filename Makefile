...
src_dirs=appinfo css img js l10n lib screenshots
...
sign_skip_msg="Skipping signing, either no key (.key) and certificate (.crt) found in $(private_key) and $(certificate) or occ can not be found at $(occ)"

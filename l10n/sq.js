OC.L10N.register(
    ...
    "Discuss" : "Diskutoni",
    "Would you like to open in new window?" : "Doni të hapet në një dritare të re?",
    "PaperHive" : "PaperHive",
    "DocID" : "DocID",
    "Saving..." : "Po ruhet …",
    "Please reload the page, error occured" : "Ju lutemi, ringarkoni faqen, ndodhi një gabim",
    "Cannot add your PaperHive document with BookID {id}. {message}" : "S’shtohet dot dokumenti juaj PaperHive me BookID {id}. {message}",
    "No such document found in database." : "S’u gjet dokument i tillë në bazën e të dhënave.",
    ...
    "Document with this BookID cannot be found" : "S’gjendet dot dokument me këtë BookID",
    "Problem connecting to PaperHive to fetch discussions." : "Problem në lidhjen me PaperHive për të sjellë diskutimet.",
    "The file already exists." : "Ka tashmë një kartelë të tillë.",
    "Could not save document." : "S’u ruajt dot dokument.",
    "Could not save document metadata." : "S’u ruajtën dot tejtëdhëna dokumenti.",
